...
<div class="p-6 space-y-6">
    @if(session('phishing_warning'))
        <div id="phishing-warning-modal" class="fixed inset-0 z-50 flex items-center justify-center bg-black/50">
            <div class="bg-white rounded-lg max-w-xl w-full mx-4 p-6 border-100 border-yellow-400 ring-4 ring-yellow-200 shadow-2xl">
                <h3 class="text-lg font-semibold mb-2">⚠️ WARNING — You Just Fell for a Simulated Phishing Attack</h3>
                <p class="text-sm text-gray-700 mb-4">Never enter your real password on untrusted websites.</p>
                <div class="text-right">
                    <button id="phishing-warning-close" class="px-4 py-2 bg-blue-600 text-white rounded">Close</button>
                </div>
            </div>
        </div>
        <script>
            (function(){
                var btn = document.getElementById('phishing-warning-close');
                var modal = document.getElementById('phishing-warning-modal');
        ...
        <div class="space-y-6">
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                ...
                <div class="space-y-2">
                    ...
                    <a href="{{ route('hacked.spot') }}" class="block w-full bg-purple-500 text-white py-3 rounded-lg text-center hover:bg-purple-600 transition-colors">
                        💸 Withdraw
                    </a>
                </div>
            </div>
